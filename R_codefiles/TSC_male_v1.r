...
bais.positive <- list.files(path = Alignment_folder, pattern = "ExD_ctrl_M.*\\.bam.bai", full.names = TRUE)
...
dir.base <- sprintf("/home/rebecca/ExomeDepth/Control_Validation_Data/MaleCount")	
